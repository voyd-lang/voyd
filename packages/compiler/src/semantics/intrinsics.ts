...
const VALUE_INTRINSICS = new Map<string, IntrinsicValueMetadata>([
  ...
  ["__i32_trunc_f32_s", { intrinsicUsesSignature: false, access: "std-only" }],
  ...
  ["__pow", { access: "std-only" }],
  ["__sin", { access: "std-only" }],
  ["__cos", { access: "std-only" }],
  ["__tan", { access: "std-only" }],
  ["__atan2", { access: "std-only" }],
  ["__ln", { access: "std-only" }],
  ["__log2", { access: "std-only" }],
  ["__log10", { access: "std-only" }],
  ["__exp", { access: "std-only" }],
  [
