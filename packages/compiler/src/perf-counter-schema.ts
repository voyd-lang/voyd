...
export const COMPILER_PERF_ZERO_PRESENCE_COUNTERS: readonly string[] = [
  ...
  "borrowing.resultIdentity.calls.conservative",
  "borrowing.resultIdentity.calls.detached",
  "borrowing.resultIdentity.calls.fresh",
  "borrowing.resultIdentity.calls.samePlace",
  "borrowing.resultIdentity.samePlace.invalidUses",
  "borrowing.staged.declarations",
  "borrowing.staged.cfgBlocks",
  "borrowing.staged.cfgEdges",
  "borrowing.staged.facts",
  "borrowing.staged.workItems",
  "borrowing.staged.forwarding",
  "borrowing.staged.traitChecks",
  "borrowing.staged.violations",
  "borrowing.staged.calls.accepted",
  "borrowing.staged.calls.conservative",
  "borrowing.builder.declarations",
  "borrowing.builder.symbols",
  "borrowing.builder.originInsertions",
  "borrowing.builder.calls",
  "borrowing.builder.forwarding",
  "borrowing.builder.traitChecks",
  "borrowing.builder.violations",
  "borrowing.builder.calls.accepted",
  "borrowing.builder.calls.conservative",
