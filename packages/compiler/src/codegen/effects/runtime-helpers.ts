...
export const OUTCOME_PAYLOAD_HELPER = "__voyd_outcome_payload";
...
export const addEffectRuntimeHelpers = (ctx: CodegenContext): void => {
  ...
  addExportedFunction({
    ctx,
    name: OUTCOME_PAYLOAD_HELPER,
    params: [outcomeType],
    result: binaryen.eqref,
    body: effectsRuntime.outcomePayload(mod.local.get(0, outcomeType)),
  });
