...
const fixtureEntryPath = process.env.VOYD_VTRACE_FAST_ENTRY
  ? path.resolve(process.env.VOYD_VTRACE_FAST_ENTRY)
  : "";
...
const regressionDescribe =
  fixtureEntryPath && fs.existsSync(fixtureEntryPath)
    ? describe
    : describe.skip;

regressionDescribe("performance: vtrace_fast regression", () => {
